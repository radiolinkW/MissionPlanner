...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://www.radiolink.com/?utm_source=Menu&utm_campaign=MP");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url  https://www.radiolink.com/");
            }
        }
